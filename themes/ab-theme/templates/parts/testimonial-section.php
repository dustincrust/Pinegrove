<?php $testimonials_section = get_field('testimonials_lp');
                    ...
                    <?php if ($testimonials_list):
                        ...
                        <div class="home-testimonials-list">
                            ...
                            <div class="swiper-buttons">
                                <div class="home-testimonials-swiper-button-prev swiper-button-prev">
                                ...
                                <div class="home-testimonials-swiper-button-next swiper-button-next">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
