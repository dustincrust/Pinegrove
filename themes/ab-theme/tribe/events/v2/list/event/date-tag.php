...
<div class="tribe-events-calendar-list__event-date-tag tribe-common-g-col">
	<time class="date-border tribe-events-calendar-list__event-date-tag-datetime" datetime="<?php echo esc_attr( $event_date_attr ); ?>">
		<span class="month font-weight-bold poppins tribe-events-calendar-list__event-date-tag-weekday">
			<?php echo esc_html( $event_month ); ?>
		</span>
		<span class="month-number poppins tribe-events-calendar-list__event-date-tag-daynum tribe-common-h5 tribe-common-h4--min-medium">
