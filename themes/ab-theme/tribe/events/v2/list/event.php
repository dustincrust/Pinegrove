...
<div <?php tribe_classes( $container_classes ); ?>>
	...
	<div class="tribe-events-calendar-list__event-wrapper tribe-common-g-col col-12">
		<article <?php tribe_classes( $event_classes ) ?>>
			<?php $this->template( 'list/event/featured-image', [ 'event' => $event ] ); ?>

			<div class="tribe-events-calendar-list__event-details tribe-common-g-col col-12">
		...
		<div class="w-100 d-flex justify-content-end pr-3">
			...
			rel="bookmark"
			>
				<div class="text-center-sm btn-text your-experience-btn">
					<button type="button" class="btn btn-outline">Register <i class="fas fa-arrow-right pl-2"></i></button>
				</div>
			</a>
		</div>
